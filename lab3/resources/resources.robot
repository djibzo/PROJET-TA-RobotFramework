...
#Scenarios pour getShippingFulfillments
...
#Scenarios pour createShippingFulfillment
...
Create Shipping Fulfillment No Pass
    ...
    ${response}=    POST On Session    ebay    /sell/fulfillment/v1/order/${wrong_order_id}/shipping_fulfillment    json=${body}     expected_status=400
    Should Be Equal As Integers    ${response.status_code}    400
    Log To Console    ${response.json()}